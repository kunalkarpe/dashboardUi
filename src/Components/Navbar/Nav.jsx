...
const Nav = () => (
  <>
    <div className="z-10 flex fixed top-0  sm:black sm:border-transparent   justify-between md:w-full lg:w-[86vw] xl:w-[86vw]  2xl:w-[88vw] sm:w-full   lg:h-16 xl:h-16 2xl:h-16  sm:h-12 items-center border border-transparent bg-white lg:ms-[18px] ">
      {/* DAshboard start*/}
      <div className="flex flex-col lg:ms-4 xl:ms-4 2x:ms-4 " >
        <h1 className="lg:text-2xl xl:text-2xl 2xl:text-2xl md:ms-4 sm:text-md font-bold items-baseline font-extrabold lg:mt-1">
          Dashboard
        </h1>
        <p className="lg:text-md xl:text-md 2xl:text-md sm:text-sm  text-slate-700 md:ms-4">14th Aug</p>
      </div>
      {/* Dashboard ends*/}
...
{/* For Image */}
        <div className="flex items-center 2xl:text-xl xl:text-xl  lg:text-xl  sm:text-md sm:mr-2 md:pr-2 font-semibold justify-center">
          <img src={girl} alt="" className="lg:w-14 lg:h-12 xl:w-14 xl:h-12 2xl:w-14 2xl:h-12 sm:h-8 sm:w-8  md:h-8 md:w-8 rounded-full" />
          <div className="flex flex-col">
            <span className=" lg:ms-3 xl:ms-3 2xl:ms-3 sm:ms-2 sm:text-sm md:ms-2 md:text-sm">Nora Watson</span>
            <p className="lg:text-sm lg:ms-3 xl:text-sm xl:ms-3 2xl:text-sm 2xl:ms-3  sm:text-sm  sm:ms-2  md:text-sm  md:ms-2 text-slate-500">Sales Manger</p>
          </div>
        </div>
      </div>
      {/* IMage ends */}
