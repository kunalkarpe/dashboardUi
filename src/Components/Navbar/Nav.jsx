...
import useLogout from "@src/Components/Navbar/Hooks/uselogoutUser";
...
const Nav = () => {
  ...
  return (
    <>
      <nav className="z-10 flex fixed top-0  sm:black sm:border-transparent   justify-between md:w-full lg:w-[86vw] xl:w-[86vw]  2xl:w-[88vw] sm:w-full   lg:h-16 xl:h-16 2xl:h-16  sm:h-12 items-center border border-transparent bg-white lg:ms-[18px] ">
